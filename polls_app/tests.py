...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_question(self):
        response = self.client.get(reverse("polls_app:base-view"))
    ...
    def test_two_past_question(self):
        ...
        choice = Choices.objects.create(question=question1, choice_text = "ONE", votes=0 )
        choice = Choices.objects.create(question=question2, choice_text = "TWENTY ONE", votes=0 )
        response = self.client.get(reverse("polls_app:base-view"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
            [question1, question2],
    ...
    def test_for_question_with_no_choice(self):
        ...
        url = reverse("polls_app:base-view")
    ...
    def test_for_question_with_choices(self):
        ...
        url = reverse("polls_app:base-view")
        response = self.client.get(url)
        self.assertTrue(response.context["latest_question_list"].exists())
